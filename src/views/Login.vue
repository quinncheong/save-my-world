...
<!--3rd draft with background stars-->
...
<template>
  <div class="container-fluid">
    ...
    <div class="row alignment">
      ...
      <div class="col-4">
        <div class="stars"></div>
        <h1 class="heading alignment">
          You have the power to <br /><span id="savemyworld"
            >#SaveOurWorld</span
          >
        </h1>
      </div>
      <div class="col-4">
        <div>
          <img class="imgsize" src="@/assets/img/newGlobe.png" />
        </div>
      </div>
      <div class="col-2"></div>
    </div>
  ...
  <div class="row mb-5">
    <section id="services" class='bg-light'>
      <div class="col-md-8 mx-auto text-center">
        <h1>Our Services</h1>
        <p>
          Lorem ipsum dolor sit amet consectetur nisi necessitatibus repellat
          distinctio eveniet eaque fuga in cumque optio consectetur harum vitae
          debitis sapiente praesentium aperiam aut
        </p>
      </div>
    </section>
  </div>
