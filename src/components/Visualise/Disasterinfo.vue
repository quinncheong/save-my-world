<template>
  ...
  <section class="timeline-section bg-dark" name="timeline-section">
    ...
    <p class="timeline-header-text">
      ...
      <span id="savemyworld">US</span> to mitigate the changes impact that such
      disasters brings as this could be avoided.
    </p>
        ...
        <section>
          ...
          <div class="bottom text-start mt-2">
            ...
            <p class="text-start collapse" id="collapse1">
              ...
              tsunami with waves that reached 12 meters high and provoked fires
              that were caused by overturned cooking stoves in numerous homes
        ...
        <section>
          ...
          <div class="bottom text-start mt-2">
            ...
            <p class="text-start collapse" id="collapse2">
              ...
              excessive rainfall which, in conjunction with the spring snowmelt
              in the mountains, led to floods along the Yangtze River which led
              to what is considered to be the deadliest natural disaster in
              world history.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div class="bottom text-start mt-2">
            ...
            <p class="text-start collapse" id="collapse3">
              In 1970, Bangladesh (at that time known as East Pakistan) was hit
              by the Bhola tropical cyclone. The wind speed, based on data by
              NOAA’s Hurricane Research Division, reached 205 km/h, making it
              the world’s deadliest tropical cyclone to date.
            </p>
          </div>
        </section>
      </div>
        ...
        <section>
          ...
          <div class="bottom text-start mt-2">
            ...
            <p class="text-start collapse" id="collapse4">
              One of the most devastating floods in history occurred in central
              China as a result of the heavy rains brought by Typhoon Nina that
              poured down over a three-day period. The typhoon was followed by
              the Banqiao dam failure on the River Ru in the western Chinese
              province of Henan on August 8 and 61 dams and reservoirs failures
              in other regions.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div class="bottom text-start mt-2">
            ...
            <p class="text-start collapse" id="collapse5">
              ...
              suffered from an earthquake of 7.8 magnitude on the Richter scale
              on July 28 at 3:42 a.m. (Beijing time). Tangshan – the Chinese
              coal-mining and industrial metropolis – was almost destroyed and
              most of the fatalities were caused by the collapse of unreinforced
              masonry dwellings in which people were sleeping. It is considered
              to be the deadliest earthquake of the 20th century.
            </p>
          </div>
        </section>
      </div>
        ...
        <section>
          ...
          <div class="bottom text-start mt-2">
            ...
            <p class="text-start collapse" id="collapse6">
              ...
              populated regions in Bangladesh with winds reaching a speed of up
              to 210 km/h. Due to a shortage of potable water and a lack of
              sanitation, the prevalence of diarrhea and dysentery rocketed with
              as many as 2,000 deaths reported in the first three weeks after
              the cyclone had hit.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div class="bottom text-start mt-2">
            ...
            <p class="text-start collapse" id="collapse7">
              ...
              Indian Ocean, provoked a massive tsunami that struck 12 countries
              in South Asia and East Africa, traveling at a speed of around 800
              km/h and generating waves as high as 30 meters. Due to its speed,
              people had little time to escape the dangerous regions.
            </p>
          </div>
        </section>
      </div>
        ...
        <section>
          ...
          <div class="bottom text-start mt-2">
            ...
            <p class="text-start collapse" id="collapse8">
              ...
              registered magnitude of 7.6 points on the Richter scale. The most
              affected regions were Kashmir and the North-West Frontier Province
              (called Khyber Pakhtunkhwa after 2010) in Pakistan and nearby
        ...
        <section>
          ...
          <div class="bottom text-start mt-2">
            ...
            <p class="text-start collapse" id="collapse9">
              This category 3 cyclone had a serious impact on Myanmar including
              its largest city Yangon and was also responsible for landfall in
              the Ayeyarwady Division. The ecology of the Ayeyarwady and Yangon
              Divisions, regions where local livelihoods are strongly dependent
              on natural resources, was devastated by Nargis.
            </p>
          </div>
        </section>
      </div>
        ...
        <section>
          ...
          <div class="bottom text-start mt-2">
            ...
            <p class="text-start collapse" id="collapse10">
              One of the deadliest earthquakes ever registered struck the small
              island country of Haiti in January 2010. With a magnitude of 7.0
              on the Richter scale and with the epicenter being 25 km from the
              capital Port-au-Prince and as one of the world’s poorest countries
              with a limited history of such high magnitude earthquakes,
              structures that were being earthquake resistant and a high
              population density, the disaster left Haiti facing high levels of
              damage, deaths, and casualties.
            </p>
          </div>
        </section>
      </div>
